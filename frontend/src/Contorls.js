...
export function Controls(props) {
  ...
  return (
    <Box display="flex" flexDirection="column" height="100%">
      ...
      {screen === "StartPage" && (
        <Slide direction="down" in={screen === "StartPage"}>
          <Fab
            size="small"
            color="primary"
      ...
      {screen === "CruisePage" && (
        <Grow in={screen === "CruisePage"}>
          <Typography sx={{ mt: 10, ml: "auto", mr: "auto" }} variant="h1">
      ...
      >
        {screen === "StartPage" && (
          <Slide direction="right" in={screen === "StartPage"}>
            <Fab
              color="primary"
              size="small"
              // onClick={() => setScreen("BasePage")}
        ...
        {screen === "StartPage" && (
          <Slide direction="left" in={screen === "StartPage"}>
            <Fab
              color="primary"
              size="small"
              // onClick={() => pass}
        ...
        <Grow in={screen === "StartPage"}>
          <Button
            ...
            onClick={() => {
              ...
              setTimeLeft(pickerValue.minutes * 60 + pickerValue.seconds);
            }}
          >
            GO
          </Button>
